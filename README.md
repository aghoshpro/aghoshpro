...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&center=true&width=600&lines=Hii+there%2C+I+am+Arka+%26+I+am+We+are+investigating+how+to+use+the+Knowledge+Graph+Framework+to+integrate+large+amounts+of+data+from+various+sources+AND+in+different+formats+under+common+semantics+BUT+we+have+realized+that+using+this+framework+might+cause+performance+issues%2C+THEREFORE%2C+we+are+concentrating+on+the+virtual+approach+of+the+proposed+framework%2C+hence+the+Virtual+Knowledge+Graph.%09)](https://git.io/typing-svg)
